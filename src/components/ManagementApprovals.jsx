...
export default function ManagementApprovals() {
  ...
  const fetchHistoryData = useCallback(async () => {
    try {
      let query = supabase
        .from("INDENT-PO")
        .select('"id","Indent Id.","Firm Name","Generated By","Type Of Indent","Material","Actual8","Approved Vendor Name","Approved Rate","Quantity","Total Quantity","Vendor Name 1","Vendor Name 2","Vendor Name 3","Rate 1","Rate 2","Rate 3","Payment Term 1","Payment Term 2","Payment Term 3","Select Rate Type 1","Select Rate Type 2","Select Rate Type 3","With Tax or Not 1","With Tax or Not 2","With Tax or Not 3","Tax Value 1","Tax Value 2","Tax Value 3","Alumina 1","Alumina 2","Alumina 3","Iron 1","Iron 2","Iron 3","SiO2 1","SiO2 2","SiO2 3","CaO 1","CaO 2","CaO 3","AP 1","AP 2","AP 3","BD 1","BD 2","BD 3","Fineness 1","Fineness 2","Fineness 3","Packaging 1","Packaging 2","Packaging 3","Transport Type 1","Transport Type 2","Transport Type 3","Expected Date 1","Expected Date 2","Expected Date 3","Quotation Number 1","Quotation Number 2","Quotation Number 3","Quotation Date 1","Quotation Date 2","Quotation Date 3","Advance Percentage 1","Advance Percentage 2","Advance Percentage 3","Technical Tag 1","Technical Tag 2","Technical Tag 3"', { count: "exact" })
        .not("Actual8", "is", null)
