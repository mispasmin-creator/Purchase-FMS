...
export default function StockApproval() {
  ...
  useEffect(() => {
    const fetchIndentsData = async () => {
      ...
      try {
        ...
        const historyCols = ["Indent Id.", "Approval Status", "Remarks", "Approved Qty", "Actual1", "Delivery Order No.", "Generated By", "Vendor", "Material", "Quantity", "Priority", "Current Stock As Per factory", "Notes", "Planned1"]
  ...
  const getHistoryTableColumns = useMemo(() => {
    const explicitHistoryColumns = [
      ...
      { dataKey: "Priority", header: "Type Of Indent" },
