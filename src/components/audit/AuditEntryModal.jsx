    ...
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-100">
      <div className="bg-white rounded-xl shadow-lg w-full max-h-[90vh] overflow-y-auto max-w-5xl">
        <div className="p-6">
          ...
          {isReAuditStage && isDebitNoteCreated && (
            <div className="mb-6">
          ...
          <div className="flex justify-end space-x-3 pt-6 mt-6 border-t border-gray-200">
            ...
            <button
              ...
              disabled={submitting || (!isGroupEdit && ['RECTIFY', 'TALLY_ENTRY', 'RE_CHECKING', 'REAUDIT', 'RE_AUDIT', 'BILL_ENTRY'].includes(row.currentStage) && formData.status !== 'Done')}
